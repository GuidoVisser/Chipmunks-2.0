...
for i in range(0, 3):
    ...
    filename = 'Diagnostics/%s_%s/result%s_%s_%s_%s.txt' % (
    print_index, len(sorted_netlist), print_index, len(sorted_netlist), count - 1, total_length)
